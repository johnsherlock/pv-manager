...
describe('costUtils', () => {
  ...
  describe('calculateHourlyNetCostAtStandardRates', () => {
    ...
    it('should return the cost using night rate if hour is 0-8 or 23', () => {
      ...
      expect(costUtils.calculateHourlyNetCostAtStandardRates(2, 'Mon', 8000000)).toEqual(0.76);
      expect(costUtils.calculateHourlyNetCostAtStandardRates(23, 'Mon', 8000000)).toEqual(0.76);
    });
    ...
    it('should return the cost using peak rate if hour is 17-19', () => {
      ...
      expect(costUtils.calculateHourlyNetCostAtStandardRates(18, 'Mon', 8000000)).toEqual(1.27);
    });

    it('should return 0 if hour is 9-17 and day is Sat', () => {
      expect(costUtils.calculateHourlyNetCostAtStandardRates(12, 'Sat', 8000000)).toEqual(0);
    });
  });
  ...
  describe('calculateDiscountedHourlyGrossCost', () => {
    it('should return the discounted gross cost using day rate if hour is between 8-16 and day is not Sat', () => {
      ...
      expect(costUtils.calculateDiscountedHourlyGrossCost(12, 'Mon', 8000000)).toEqual(0.96);
    });
    ...
    it('should return the discounted gross cost using night rate if hour is 0-8 or 23', () => {
      ...
      expect(costUtils.calculateDiscountedHourlyGrossCost(2, 'Mon', 8000000)).toEqual(0.70);
      expect(costUtils.calculateDiscountedHourlyGrossCost(23, 'Mon', 8000000)).toEqual(0.70);
    });
    ...
    it('should return the discounted gross cost using peak rate if hour is 17-19', () => {
      ...
      expect(costUtils.calculateDiscountedHourlyGrossCost(18, 'Mon', 8000000)).toEqual(1.18);
    });

    it('should return 0 if hour is 9-17 and day is Sat', () => {
      expect(costUtils.calculateDiscountedHourlyGrossCost(12, 'Sat', 8000000)).toEqual(0);
    });
  });
  ...
  describe('calculateHourlyGrossCostIncStdChgAndDiscount', () => {
    it('should return the gross cost using night rate if hour is 0-8 or 23, day is Mon and joules is 8000000', () => {
      ...
      expect(costUtils.calculateHourlyGrossCostIncStdChgAndDiscount(2, 'Mon', 8000000)).toEqual(0.74);
      expect(costUtils.calculateHourlyGrossCostIncStdChgAndDiscount(23, 'Mon', 8000000)).toEqual(0.74);
    });
    ...
    it('should return the gross cost using peak rate if hour is 17-19, day is Mon and joules is 8000000', () => {
      ...
      expect(costUtils.calculateHourlyGrossCostIncStdChgAndDiscount(18, 'Mon', 8000000)).toEqual(1.21);
    });
    ...
    it('should return the gross cost using day rate if hour is 8-16, day is not Sat and joules is 8000000', () => {
      ...
      expect(costUtils.calculateHourlyGrossCostIncStdChgAndDiscount(12, 'Mon', 8000000)).toEqual(1);
    });
  });
  ...
  describe('calculateSaturdaySaving', () => {
    ...
    it('returns 0 if hour is less than 9', () => {
      ...
      expect(costUtils.calculateSaturdaySaving(8, 'Sat', 800000)).toEqual(0);
    });

    it('returns 0 if hour is greater than 17', () => {
      // expected value is 0 because hour is greater than 17
      expect(costUtils.calculateSaturdaySaving(18, 'Sat', 800000)).toEqual(0);
    });
    ...
    it('returns the gross saving at discounted rates if joules, day and hour is provided', () => {
      ...
      expect(costUtils.calculateSaturdaySaving(12, 'Sat', 8000000)).toEqual(0.96);
    });
  });
  ...
  describe('calculateDiscountedGrossCostExcludingStdChg', () => {
    it('returns the correct discounted gross cost excluding the standing charge', () => {
      ...
      expect(costUtils.calculateDiscountedGrossCostExcludingStdChg(netCostAtStandardRate)).toEqual(9.27);
    });
  });
