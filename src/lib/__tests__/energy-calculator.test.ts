...
describe('EnergyCalculator', () => {
  ...
  describe('calculateHourlyNetCostAtStandardRates', () => {
    it('should return the cost using day rate if hour is between 8-16 and day is not Sat', () => {
      ...
      expect(energyCalculator.calculateHourlyNetCostAtStandardRates(12, 'Mon', 8000000)).toEqual(1.04);
    });
    ...
    it('should return the cost using night rate if hour is 0-8 or 23', () => {
      ...
      expect(energyCalculator.calculateHourlyNetCostAtStandardRates(2, 'Mon', 8000000)).toEqual(0.76);
      expect(energyCalculator.calculateHourlyNetCostAtStandardRates(23, 'Mon', 8000000)).toEqual(0.76);
    });
    ...
    it('should return the cost using peak rate if hour is 17-19', () => {
      ...
      expect(energyCalculator.calculateHourlyNetCostAtStandardRates(18, 'Mon', 8000000)).toEqual(1.27);
    });

    it('should return 0 if hour is 9-17 and day is Sat', () => {
      expect(energyCalculator.calculateHourlyNetCostAtStandardRates(12, 'Sat', 8000000)).toEqual(0);
    });
  });
  ...
  describe('calculateDiscountedHourlyGrossCost', () => {
    it('should return the discounted gross cost using day rate if hour is between 8-16 and day is not Sat', () => {
      ...
      expect(energyCalculator.calculateDiscountedHourlyGrossCost(12, 'Mon', 8000000)).toEqual(0.96);
    });
    ...
    it('should return the discounted gross cost using night rate if hour is 0-8 or 23', () => {
      ...
      expect(energyCalculator.calculateDiscountedHourlyGrossCost(2, 'Mon', 8000000)).toEqual(0.70);
      expect(energyCalculator.calculateDiscountedHourlyGrossCost(23, 'Mon', 8000000)).toEqual(0.70);
    });
    ...
    it('should return the discounted gross cost using peak rate if hour is 17-19', () => {
      ...
      expect(energyCalculator.calculateDiscountedHourlyGrossCost(18, 'Mon', 8000000)).toEqual(1.18);
    });

    it('should return 0 if hour is 9-17 and day is Sat', () => {
      expect(energyCalculator.calculateDiscountedHourlyGrossCost(12, 'Sat', 8000000)).toEqual(0);
    });
  });
  ...
  describe('calculateHourlyGrossCostIncStdChgAndDiscount', () => {
    it('should return the gross cost using night rate if hour is 0-8 or 23, day is Mon and joules is 8000000', () => {
      ...
      expect(energyCalculator.calculateHourlyGrossCostIncStdChgAndDiscount(2, 'Mon', 8000000)).toEqual(0.74);
      expect(energyCalculator.calculateHourlyGrossCostIncStdChgAndDiscount(23, 'Mon', 8000000)).toEqual(0.74);
    });
    ...
    it('should return the gross cost using peak rate if hour is 17-19, day is Mon and joules is 8000000', () => {
      ...
      expect(energyCalculator.calculateHourlyGrossCostIncStdChgAndDiscount(18, 'Mon', 8000000)).toEqual(1.21);
    });
    ...
    it('should return the gross cost using day rate if hour is 8-16, day is not Sat and joules is 8000000', () => {
      ...
      expect(energyCalculator.calculateHourlyGrossCostIncStdChgAndDiscount(12, 'Mon', 8000000)).toEqual(1);
    });
  });
